...
1. Quit Illustrator.
2. Copy *EnhancedFreeDistort.aip* into the shared plugin folder for Illustrator 2026, *%LOCALAPPDATA%\Adobe Illustrator Plug-ins\30*. Other plugins live there too; do not make a folder of its own.
...
1. Select one object.
2. Choose *Effect > Distort & Transform > Enhanced Free Distort…* (if Illustrator put it elsewhere, *Object > Transform > Enhanced Free Distort…*). The object gets a *Free Distort* if it has none, and the *Free Distort Editor* tool is selected.
...
- [docs/ENHANCED_FREE_DISTORT_INVESTIGATION.md](docs/ENHANCED_FREE_DISTORT_INVESTIGATION.md): what Adobe's effect actually does, and why the plugin is built this way
