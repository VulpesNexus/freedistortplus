...
FEATURES = [
    ...
    ("capability", "Snapping, through Illustrator's own Smart Guides", "no", "yes: art, guides, grid, artboards, and the undistorted corners, center, and edges; tolerance in screen pixels; follows View > Smart Guides", "yes",
     [("manual-snap", "lands on the anchor exactly"), ("snap", "lands there exactly"), ("snap", "undistorted center"), ("snap", "far from every target"),
      ("snap", "never breaks the axis lock"), ("snap", "does not snap back"), ("snap", "half a point still does"), ("snap", "own targets do not snap")]),
    ...
    ("limit", "Illustrator 30.7.0 can crash or hang after a script closes and reopens documents", "the same", "the same: it reproduces with no third-party plugin loaded, at the offsets the probes died at (crash-ab evidence)", "n/a", []),
