...
| Snapping, through Illustrator's own Smart Guides | no | yes: art, guides, grid, artboards, and the undistorted corners, center, and edges; tolerance in screen pixels; follows View > Smart Guides | yes | verified |
...
| Illustrator 30.7.0 can crash or hang after a script closes and reopens documents | the same | the same: it reproduces with no third-party plugin loaded, at the offsets the probes died at (crash-ab evidence) | n/a | design limit |
